...
public class SpawnCondition {
    ...
    /**
     * Will run this map generation component underneath the structure,
     * creating a platform to support the structure
     */
    public Class<? extends SupportComponentBase> platform;
