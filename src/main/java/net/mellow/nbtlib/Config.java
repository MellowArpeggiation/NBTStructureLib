...
public class Config {
    ...
    public static void synchronizeConfiguration(File configFile) {
        ...
        debugStructures = configuration.getBoolean("debugStructures", Configuration.CATEGORY_GENERAL, debugStructures, "Should structures generate exactly as they are in the structure file, without replacements? (If on, will force-enable dedicated server block registration)");

        registerOnDedicated = configuration.getBoolean("registerOnDedicated", Configuration.CATEGORY_GENERAL, registerOnDedicated, "Should we register blocks on dedicated servers? If disabled, connecting clients do not need the mod installed!");
